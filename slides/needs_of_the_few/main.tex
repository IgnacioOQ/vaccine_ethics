...
\pause
  \item \textbf{Viral age}, the distinctive ingredient: Lethality \emph{decreases} with each transmission (transmission-virulence trade-off). It does not change virulence or recovery time.
\end{itemize}
...
\begin{frame}{Precautionary Principle: Worst cases cut the other way}
\begin{figure}
  \centering
...
\textbf{\textit{The PP dictates that we may rationally prefer S1.}}
\end{frame}
